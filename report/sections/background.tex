...
% ! More background wanted for graphics.
% ! Add comparisions to other libraries.
% Quite broad at the moment, narrow in, and compare options to then justify my choices.
