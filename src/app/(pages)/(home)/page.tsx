...
import southAfrica from "assets/images/examples/southAfrica.png";
...
export default function Home(): ReactNode {
    ...
    const staticExamples: Array<{ name: string; code: string; image: StaticImageData; }> = [
        ...
        {
            code: "%2B3xwcDh1hFILBELgUNiqHMXm8CLgSMqNXpxO6xxkrDZRLg%2BkkrB5OPg01mhou92O7WxfLgnTg%2BsF1NWIq%2BP2VPn%2B7xl4Os2DwhHQHw8vFE7WKcAAZBLLFgSgnfaq5tLQUHIrzcQpJOhOi6AMowdyweVQMLAIRRjAQCzbTwQNTWDICAB0qBA7hrcAAXP24ABJADyHV63d7IlIAiEre2ABIJSr%2BA353B%2BIIRO1PAJ3OEAMLuIQAN3cQPlpLgjpycwAPI-PpHUEA",
            image: southAfrica,
            name: "South Africa",
        },
        {
