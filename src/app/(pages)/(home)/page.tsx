...
export default function Home(): ReactNode {
    ...
    const staticExamples: Array<{ name: string; code: string; image: StaticImageData; }> = [
        ...
        {
            code: "JYWwDg9gTgLgBAGWAIwFCoLQbgZQKbwwAWecAxgIYB2AbhQM5z3ABeeqjAvHAIwAMA9FjgARKBQDucPBTJE4YCrDgQAZnGKlVAGwgS8UDjDwg43ZHhbADAJjgAKAGp4yMaA74A6ACwBWOABUTACUIQ7Oru72XgDs-kH0oYlwAHxpGuJU9NoUxuEublAOjAD0cDah9qXlwaFpKUwwUBAA1ngA6njAAOZE8FVwZfx8den0Ta2kAOJQeHhUqGAEFNpcDhZWBgDM%2BZFFjCO7hXB8YU4F7ozJ9XCqwNracAAmSi2ocB%2BfHwBkcBvWUB25z2JzOEWOB0q4MuYRudwecG0PT67y%2Bn1%2B-22R3cp0OwIhYIu%2BxOowaTWo2VyeAAmkxUul4Y8XlA3mj0X9LACgdDicl8TiSdjiYcbuSsjljLTGHD7o8kb0YKS4FQIDgJm1URISLNUR95X0zHAAArAKisz7MlofbhG7QAVxAi2A43uhrIwCgZG0pGinh48Vh6TFlLy-KKAzKFWKgxqSpVauabXpDUZcGpeAeeiE2DVSngEigwBgpu6cAAnhA7UUyBAnqRtXhPKgQBRTXAAFztuAASQA8g5gs3W1RDbMqHWigAScjUOiMAA8i8aJjgvyWMBWjDXzuL2k1Dd1M9oDDdsypAGFZyf7M07eOzrf74kgA",
            image: flower,
            name: "4 Petal Flower",
        },
    ];
