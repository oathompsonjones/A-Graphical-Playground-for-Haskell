...
import { Avatar, Button, Card, CardContent, FormControl, Paper, TextField, Typography } from "@mui/material";
                                ...
                                onChange={(e) => {
                                    ...
                                    if (file) {
                                        ...
                                        reader.onload = (): void => {
                                            ...
                                            // Get max width and max height of image without distoring the aspect ratio.
                    ...
                    : sketches.map((sketch, i) => (
                        <Card key={i}>
                            <CardContent className={styles.sketchMain!}>
                                ...
                                <Button color="error" onClick={() => onDeleteClick(sketch)} size="small">Delete</Button>
                            </CardContent>
                            <CardContent>
                                <Typography variant="caption" color="textDisabled">
                                    <b>Created At:</b> {new Date(parseInt(sketch.createdAt, 10)).toLocaleString()}
                                </Typography>
                                <br />
                                <Typography variant="caption" color="textDisabled">
                                    <b>Last Edited At:</b> {new Date(parseInt(sketch.modifiedAt, 10)).toLocaleString()}
                                </Typography>
                            </CardContent>
                        </Card>
                    ))}
